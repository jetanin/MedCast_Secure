...
## 📦 สิ่งที่ต้องส่งประกวด (Deliverables)

- [ ] 🎬 คลิปวิดีโอแนะนำผลงาน (ไม่เกิน 3 นาที)
- [ ] 🖼️ Graphical Abstract สรุปแนวคิด 1 หน้า (A4)
- [ ] 📄 Proposal รายละเอียดผลงานและแนวคิด (ไม่เกิน 5 หน้า)
- [x] 🧪 Prototype + **Demo** (Streamlit dashboard + pipeline 00–05)
